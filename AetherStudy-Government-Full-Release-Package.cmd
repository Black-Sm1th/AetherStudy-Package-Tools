@echo off
setlocal
title AetherStudy Government Full Release Package
...
echo Starting clean government edition release build...
echo This mode rebuilds backend and client and uses maximum compression.
echo.
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%PACK_SCRIPT%" -Edition Government -Clean
