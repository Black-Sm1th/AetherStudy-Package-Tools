@echo off
setlocal
title AetherStudy Fast One-Click Package
...
echo Starting optimized package build...
echo Unchanged backend/client components will be reused automatically.
echo.
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%PACK_SCRIPT%" -Edition Main -Fast
